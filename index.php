        ...
        <li>
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <a href="#">
                <?php 
          $show_pic = "SELECT `img` FROM `user` WHERE u_name=".$_SESSION['user_login'];

          $img = mysqli_query($conn,$show_pic);

          $row = mysqli_fetch_object($img)

          ?>
                <img src="images/<?=$row['img']; ?>" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
      ...
      <div class="form-inline">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="#index.php?view=showproduct.php" class="nav-link">
